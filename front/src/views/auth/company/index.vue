...
import { dataList, deleteOne } from '@/api/auth/company_api'
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['id', '名称', '联系人', '电话', '创建时间']
        const filterVal = ['id', 'name', 'contact_user', 'phone', 'created_at']
